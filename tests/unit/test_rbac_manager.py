...
from kube_orchestrator.resources.rbac.role_binding import ClusterRoleBindingManager, RoleBindingManager
...
class TestRoleManager:
    def test_create_role(self, role_manager: RoleManager, mock_rbac_v1: MagicMock) -> None:
    ...
    def test_delete_role(self, role_manager: RoleManager, mock_rbac_v1: MagicMock) -> None:
...
class TestClusterRoleManager:
    def test_create_cluster_role(self, cr_manager: ClusterRoleManager, mock_rbac_v1: MagicMock) -> None:
...
class TestRoleBindingManager:
    def test_bind_service_account(self, rb_manager: RoleBindingManager, mock_rbac_v1: MagicMock) -> None:
    ...
    def test_list_rolebindings(self, rb_manager: RoleBindingManager, mock_rbac_v1: MagicMock) -> None:
        mock_list = MagicMock()
...
class TestServiceAccountManager:
    def test_create_service_account(self, sa_manager: ServiceAccountManager, mock_core_v1: MagicMock) -> None:

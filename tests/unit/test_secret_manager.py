...
class TestSecretManager:
    def test_create_opaque_secret(self, secret_manager: SecretManager, mock_core_v1: MagicMock) -> None:
    ...
    def test_create_tls_secret(self, secret_manager: SecretManager, mock_core_v1: MagicMock, tmp_path) -> None:
